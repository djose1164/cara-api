...
function findWasmBinary() {
  return locateFile("CaraClient.wasm");
}
...
function saveFile(contentPointer, contentLength, filename) {
  const filenameHint = UTF8ToString(filename);
  const fileContent = Module.HEAP8.subarray(contentPointer, contentPointer + contentLength);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = CaraClient_entry;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = CaraClient_entry;
} else if (typeof define === 'function' && define['amd'])
  define([], () => CaraClient_entry);
